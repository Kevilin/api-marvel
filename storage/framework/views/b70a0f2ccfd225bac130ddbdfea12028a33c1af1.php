          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100">
              ...
              <div class="card-body text-center">
                <h5 class="card-title fs-1">Herói: <?php echo e($heroi->nome); ?></h5>
                <p class="card-text fs-4 mt-2"><?php echo e($heroi->descricao); ?></p>
              </div>
              <button type="button" class="btn btn-primary fs-3" data-bs-toggle="modal" data-bs-target="#modal<?php echo e($heroi->id); ?>">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-A3rJD856KowSb7dwlZdYEkO39Gagi7vIsF0jrRAoQmDKKtQBHUuLZ9AsSv4jD4Xa" crossorigin="anonymous"></script><?php /**PATH /home/kevilinrodrigues/Área de Trabalho/marvel/api-marvel/resources/views/index.blade.php ENDPATH**/ ?>